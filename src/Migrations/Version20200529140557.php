 ...
 */
final class Version20200529140557 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE location ADD create_time DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE tool_id tool_id INT DEFAULT NULL, CHANGE workstation_id workstation_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE location DROP create_time');
