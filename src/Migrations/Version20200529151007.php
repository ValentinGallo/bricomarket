 ...
 */
final class Version20200529151007 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE location CHANGE is_accept is_accept TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE tool_id tool_id INT DEFAULT NULL, CHANGE workstation_id workstation_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE location CHANGE is_accept is_accept TINYINT(1) NOT NULL');
